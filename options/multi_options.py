...
class Multi_Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--experiment_name', type=str, default='multi', help='name of the experiment. It decides where to load datafiles, store samples and models')

...
class Deep_Options():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--data_root', type=str, default='/media/hlf/Luffy/WLS/ContestCD/CDdata/trainData', help='path to dataroot')
        parser.add_argument('--dataset', type=str, default='contest', help='[LEVIR-CD-CD|WHU]')
        parser.add_argument('--experiment_name', type=str, default='deep', help='name of the experiment. It decides where to load datafiles, store samples and models')
        parser.add_argument('--save_path', type=str, default='/media/hlf/Luffy/WLS/ContestCD/save', help='models are saved here')
        parser.add_argument('--data_inform_path', type=str, default='/media/hlf/Luffy/WLS/ContestCD/datafiles', help='path to files about the datafiles information')

        # model parameter
        parser.add_argument('--backbone', type=str, default='resnet34', help='which resnet')
        ...
        parser.add_argument('--num_epochs', type=int, default=80, help='num of epochs')

...
class Edge_Options():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--data_root', type=str, default='/media/hlf/Luffy/WLS/ContestCD/CDdata', help='path to dataroot')
        parser.add_argument('--dataset', type=str, default='contest', help='[LEVIR-CD-CD|WHU]')
        parser.add_argument('--experiment_name', type=str, default='edge', help='name of the experiment. It decides where to load datafiles, store samples and models')

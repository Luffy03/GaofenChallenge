...
from models.backbone.bricks import BuildNormalization, BuildActivation
...
'''build resnet'''
def BuildResNet(resnet_type, pretrained, **kwargs):
    ...
    if pretrained:
        ...
        print('load pretrained resnet50_v1c model')

    # return the model
    return model


def resnet50_v1c(pretrained=True):
